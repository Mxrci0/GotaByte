    ...
    <main class="flex-grow p-6">
        <div class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow">
            ...
            <form action="/login/alterar" method="POST" id="form_pf" class=" space-y-3 border rounded p-4">
                ...
                <input type="text" name="cpf" placeholder="CPF"  value="<?= $this->getView()->login->__get('cpf') ?>"class="w-full p-2 border rounded" required>
                <input type="email" name="email" placeholder="E-mail" value="<?= $this->getView()->login->__get('email') ?>" class="w-full p-2 border rounded" required>
